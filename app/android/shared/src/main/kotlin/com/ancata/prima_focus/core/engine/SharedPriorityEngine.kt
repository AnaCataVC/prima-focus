package com.ancata.prima_focus.core.engine
...
class SharedPriorityEngine {

    /**
     * Calculates and updates a task's priority score without task duration bias.
     * Returns a copy of the model with the updated score.
     */
    fun calculatePriority(task: Task, currentTimeMs: Long = System.currentTimeMillis()): Task {
