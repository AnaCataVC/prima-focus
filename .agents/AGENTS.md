...
2. **Nuevos Releases / APKs:** Si hay un nuevo APK finalizado o se crea un release importante, debes copiar el APK a la ruta `C:\Users\anaca\Repos\prima-focus-showcase\apk\`, actualizar el repositorio y, muy importante, **generar un nuevo Release en GitHub para el Showcase** (usando `gh release create`) con notas de versión detalladas para que el APK actualizado pueda ser descargado desde la página del release.
